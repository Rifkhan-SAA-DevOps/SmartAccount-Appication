export const ROLE_PERMISSIONS = {
  ...
  ADMIN: [
    ...
    'payment:*', 'return:*', 'ledger:read', 'statement:*', 'cheque:*', 'warranty:*', 'manufacturing:*', 'batch:*', 'service:*', 'crm:*', 'quotation:*', 'hr:*', 'project:*', 'installment:*', 'bankrecon:*', 'asset:*', 'currency:*', 'loyalty:*', 'delivery:*', 'budget:*', 'campaign:*', 'dashboardbuilder:*', 'security:*', 'cashbank:*', 'accounting:*', 'approval:*', 'notification:*', 'audit:*', 'settings:*', 'document:*', 'branch:*', 'report:read', 'user:read', 'subscription:read'
  ],
  ACCOUNTANT: [
    'dashboard:read', 'customer:read', 'supplier:read', 'product:read',
    'invoice:*', 'purchase:*', 'payment:*', 'return:*', 'ledger:read', 'statement:*', 'cheque:*', 'warranty:*', 'manufacturing:*', 'batch:*', 'service:*', 'crm:*', 'quotation:*', 'hr:*', 'project:*', 'installment:*', 'bankrecon:*', 'asset:*', 'currency:*', 'loyalty:*', 'delivery:*', 'budget:*', 'campaign:*', 'dashboardbuilder:*', 'cashbank:*', 'accounting:*', 'approval:*', 'notification:*', 'audit:read', 'security:read', 'settings:read', 'document:*', 'branch:read', 'report:read'
  ],
  CASHIER: [
  ...
  VIEWER: ['dashboard:read', 'branch:read', 'ledger:read', 'statement:read', 'statement:export', 'cheque:read', 'warranty:read', 'manufacturing:read', 'batch:read', 'service:read', 'crm:read', 'quotation:read', 'hr:read', 'project:read', 'installment:read', 'bankrecon:read', 'asset:read', 'currency:read', 'loyalty:read', 'delivery:read', 'budget:read', 'campaign:read', 'dashboardbuilder:read', 'cashbank:read', 'accounting:read', 'settings:read', 'approval:read', 'document:read', 'notification:read', 'audit:read', 'security:read', 'report:read'],
  AUDITOR: ['dashboard:read', 'branch:read', 'ledger:read', 'statement:read', 'statement:export', 'cheque:read', 'warranty:read', 'manufacturing:read', 'batch:read', 'service:read', 'crm:read', 'quotation:read', 'hr:read', 'project:read', 'installment:read', 'bankrecon:read', 'asset:read', 'currency:read', 'loyalty:read', 'delivery:read', 'budget:read', 'campaign:read', 'dashboardbuilder:read', 'cashbank:read', 'accounting:read', 'settings:read', 'approval:read', 'document:read', 'notification:read', 'report:read', 'audit:read', 'security:read']
};
