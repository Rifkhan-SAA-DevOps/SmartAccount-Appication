...
const importLine = "import repMobileRoutes from './routes/repMobile.routes.js';";
if (!app.includes(importLine)) {
  const markers = [
    "import distributorDashboardRoutes from './routes/distributorDashboard.routes.js';",
...
const useLine = "app.use('/api/rep-mobile', repMobileRoutes);";
...
console.log('Registered /api/rep-mobile route in src/app.js');
