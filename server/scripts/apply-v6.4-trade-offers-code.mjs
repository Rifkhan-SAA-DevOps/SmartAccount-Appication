...
const importLine = "import tradeOffersRoutes from './routes/tradeOffers.routes.js';";
...
const useLine = "app.use('/api/trade-offers', tradeOffersRoutes);";
...
console.log('Registered /api/trade-offers route in src/app.js');
