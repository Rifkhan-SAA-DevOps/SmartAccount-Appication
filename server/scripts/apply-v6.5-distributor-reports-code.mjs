...
const importLine = "import distributorReportsRoutes from './routes/distributorReports.routes.js';";
...
const useLine = "app.use('/api/distributor-reports', distributorReportsRoutes);";
...
console.log('Registered /api/distributor-reports route in src/app.js');
